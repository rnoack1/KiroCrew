...
class TestSlotContextInject:
    ...
    async def test_owning_app_is_allowed(self, _sel):
        ...
        # NO per-POST durability flag: the queue round-trips on the ordinary flush/close
        # paths, so the endpoint reports queue state only and forces no save of its own.
