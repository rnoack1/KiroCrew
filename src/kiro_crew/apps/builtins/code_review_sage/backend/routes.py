...
async def _handle_chat_get(request: web.Request) -> web.Response:
    ...
    return web.json_response({
        ...
        "can_ask": chat_session.override_active(),
    })
...
async def _handle_chat_post(request: web.Request) -> web.Response:
    ...
    def _persist() -> list[dict]:
        history = chat_session.read_transcript(run_id, change_id)
    ...
    try:
        ...
        # The run's directory went away between the check above and the write.
