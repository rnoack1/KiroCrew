...
function ChipBadge() {
  return (
    <span data-testid="recommended-badge" className="shrink-0 self-center rounded-full px-1.5 py-[1px] text-[10px] font-medium uppercase tracking-wide leading-none bg-accent text-accent-fg">
