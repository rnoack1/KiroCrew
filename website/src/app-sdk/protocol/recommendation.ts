...
// Labels opening with one of these DISPATCH as a harness command, a prompt mention, a local
// skill body, or reserved provenance. Mirrored on the backend; a test fails if the two diverge.
