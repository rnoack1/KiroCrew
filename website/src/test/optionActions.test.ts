...
import { OPTION_MARKER_RE, __OPTION_ACTION_MARKER_RE_FOR_TESTS as OPTION_ACTION_MARKER_RE, stripPartialOptionMarker, matchActionMarkers, stripOptionMarkers } from '../app-sdk/protocol/optionMarker'
