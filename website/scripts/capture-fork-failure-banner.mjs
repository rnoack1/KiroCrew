...
const SCENES = [
  ...
  { scene: 'sidebar-duplicate', direction: 'head', theme: 'dark', expect: /end you want to keep/i },
  { scene: 'sidebar-duplicate', direction: 'head', theme: 'light', expect: /end you want to keep/i },
  { scene: 'grid-pane', direction: 'head', theme: 'dark', expect: /end you want to keep/i },
  { scene: 'grid-pane', direction: 'head', theme: 'light', expect: /end you want to keep/i },
]
