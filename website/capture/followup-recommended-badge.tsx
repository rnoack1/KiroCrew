 ...
 * a label short enough to fit shows the marker either way and demonstrates
 * nothing. Its marker TRAILS deliberately -- that is the drift shape the parser
 * tolerates but the producer rule does not sanction, and it is the only shape the
 * clipping defect reproduces on, since a leading marker is never what the ellipsis
 * eats. The badge is what makes the tolerated shape legible. The last is the
 * ordering variant.
 */
const RAW = [
  'Start the walk with the 4 badged items in board order (recommended)',
