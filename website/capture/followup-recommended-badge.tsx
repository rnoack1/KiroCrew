...
const options = declinedMode ? parsedDeclined.options : fixOn ? parsed.options : RAW
const recommended = declinedMode ? parsedDeclined.recommended : fixOn ? parsed.recommended : undefined
